...
from department_app.tests.test_data import department_1, department_to_json
...
class TestDepartmentService(TestCaseBase):
    ...
    def test_get_departments(self):
        with patch(
                'service.department_service.StrategiesService._check_strategy'
    ...
    def test_get_department_by_uuid_success(self):
        ...
        with patch(
            ...
            DepartmentService.get_department(uuid)
    ...
    def test_get_department_by_uuid_failure(self):
        with patch(
            ...
            with self.assertRaises(ValueError):
                DepartmentService.get_department(self.invalid_uuid)
    ...
    def test_get_department_by_name(self):
        ...
        with patch(
            ...
            DepartmentService.get_department_by_name(
                name
            )
            db_session_mock.query().filter_by.assert_called_once_with(
                name=name
    ...
    def test_update_department_success(self):
        ...
        with patch(
            ...
            DepartmentService.get_department.assert_called_once_with(
                uuid
            )
            schema.load.assert_called_once_with(
                department_json,
...
class GetDepartmentByUUIDMock:
    def __init__(self, return_value=None):
        ...
        self.original = DepartmentService.get_department
