...
from department_app.tests.test_data import employee_1, employee_to_json, \
...
class TestEmployeeService(TestCaseBase):
    ...
    def test_get_employees(self):
        with patch(
                'service.employee_service.StrategiesService._check_strategy'
    ...
    def test_get_employee_by_uuid_success(self):
        ...
        with patch(
            ...
            EmployeeService.get_employee(uuid)
    ...
    def test_get_employee_by_uuid_failure(self):
        with patch(
            ...
            with self.assertRaises(ValueError):
                EmployeeService.get_employee(self.invalid_uuid)
    ...
    def test_update_employee_success(self):
        ...
        with patch(
            ...
            EmployeeService.get_employee.assert_called_once_with(
                uuid
            )
            schema.load.assert_called_once_with(
                employee_json,
    ...
    def test_get_employees_by_date(self):
        expected = [employee_1, employee_2]
        search_date = employee_1.birthdate
    ...
    def test_get_employees_born_in_period(self):
        ...
        with patch(
            ...
            strategy = selectinload
            result = EmployeeService.get_employees_between_dates(
...
class GetEmployeeByUUIDMock:
    def __init__(self, return_value=None):
        ...
        self.original = EmployeeService.get_employee
