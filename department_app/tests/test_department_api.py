...
from department_app.tests.test_data import department_to_json, department_1, \
    department_2
...
class TestDepartmentApi(TestCaseBase):
    ...
    def test_get_department_success(self):
        ...
        with patch(
                'rest.department_api.DepartmentService.get_department',
                autospec=True,
                return_value=mock_return_value
    ...
    def test_delete_department_success(self):
        ...
        with patch(
            ...
            self.__test_delete_department(
                ...
                DepartmentApi.NO_CONTENT_ERROR
            )
