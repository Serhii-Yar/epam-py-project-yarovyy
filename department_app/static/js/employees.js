...
let SEARCH_BY_DATE_FORM_ID = "#search-by-date-form";
let SEARCH_BY_DATE_PERIOD_FORM_ID = "#search-by-date-period-form";
...
function initSearchByDateButton() {
    $(SEARCH_BY_DATE_FORM_ID).submit(function () {
...
function initSearchToggleCheckbox() {
    let searchByDateForm = $(SEARCH_BY_DATE_FORM_ID);
    let searchByPeriodForm = $(SEARCH_BY_DATE_PERIOD_FORM_ID);
...
function initSearchByPeriodButton() {
    $(SEARCH_BY_DATE_PERIOD_FORM_ID).submit(function () {
